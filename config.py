...
class Config:
    ...
    OPENAI_ASSISTANT_COVER_LETTER_CREATE = config["DEFAULT"][
        "OPENAI_ASSISTANT_COVER_LETTER_CREATE"
    ]
    OPENAI_ASSISTANT_RESUME_CREATE = config["DEFAULT"]["OPENAI_ASSISTANT_RESUME_CREATE"]
